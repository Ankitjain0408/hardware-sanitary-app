...
function ServiceSupport({ onClose }) {
  return (
        ...
        <div className="bg-gray-50 rounded-lg p-8 md:p-12 shadow-lg">
          <div className="space-y-6">
            <p className="text-gray-600 text-base mb-6">
              Our support team is available to assist you with product inquiries, orders, and general support.
            </p>
            ...
            <div className="pt-6 border-t border-gray-200">
              <div className="space-y-3">
                <p className="text-gray-600 text-base flex items-center gap-2">
                  <span>🕘</span> <span><span className="font-semibold text-gray-900">Support Hours:</span> 10:00 AM – 8:00 PM, Working Days</span>
                </p>
                <p className="text-gray-600 text-base flex items-center gap-2">
                  <span>💬</span> <span>WhatsApp support available for quick responses</span>
                </p>
              </div>
            </div>
